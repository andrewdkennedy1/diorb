...
fn test_start_screen_integration() {
    ...
    // Test initial state
    assert_eq!(start_screen.selected_option().display_text(), "Start Test");
    
    // Test navigation
    start_screen.select_next();
    assert_eq!(start_screen.selected_option().display_text(), "View Results");
    
    start_screen.select_next();
    assert_eq!(start_screen.selected_option().display_text(), "Settings");
    
    start_screen.select_next();
    assert_eq!(start_screen.selected_option().display_text(), "Exit");
